...
* 📝 Vous apprendrez à connaître vos partenaires de manière douteuse au travers les exercices qui suivent
...
* Envoyez un Mio à l'enseignant(e) 
...
Certains cours en TIM utilisent Google Classroom pour distribuer les notes de cours et devoirs.
...
* Se connecter son compte Google institutionnel. (Il existe déjà automatiquement !)
  * Identifiant : `matricule@gmail.com` (ex : `1676767@gmail.com`)
  * Mot de passe : Identique à celui d'Omnivox
* Joindre un cours à l'aide du code fourni par l'enseignant(e)
* Récupérer des notes de cours
* Récupérer, compléter, puis remettre un travail
...
* Créer un dossier pour la session A26
...
* ⚠ Une fois le formulaire soumis, appuyer sur le bouton pour vérifier ses réponses !
