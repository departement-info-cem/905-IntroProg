...
⏰ Date de remise : 
* Groupes de Maxime P : **18 septembre à 23h59**. (Remise sur Teams)
* Groupes de David M : **21 sepmbte à 23h59**. (Remise sur Léa)
...
Pour que les chances de gagner du **détective** soient *raisonnables*, les chiffres du code peuvent seulement être des nombres de `1` à `4`. (Ex : `123`, `111`, `421`, etc.) De plus, à chaque tentative, si un nombre est valide, son fond devient vert.
...
<tr>
    ...
    <td>Au fil de la partie, ces variables vont varier de `1` à `4`.</td>
</tr>
<tr>
    <td>Trois variables pour noter le code secret choisi par le **gardien**.</td>
    <td>Ces trois variables commenceront avec la valeur `1`.</td>
    <td>Lorsque le **gardien** valide son choix de code secret, ces variables vont changer de valeur et contiendront chacune le nombre de `1` à `4` choisi.</td>
</tr>
<tr>
...
Attention ! N'oubliez pas que les trois chiffres doivent être coincés entre `1` et `4`. (Inclus) 

* Lorsque vous augmentez un chiffre, assurez-vous de l'empêcher d'aller plus haut que 4. 
...
Lorsque vous aurez terminé tous les TODOs, si vous remarquez que vous avez du mal à **rejouer** une deuxième fois en testant, il est possible que le ou les *bogues* soient situés dans le TODO 4.
...
<table>
    ...
    <tr>
        <td>TODO 3 : <br/>- On peut augmenter et diminuer la valeur des trois chiffres affichés tel que demandé.<br/>- Impossible d'aller sous 1 ou au-dessus de 4.</td>
