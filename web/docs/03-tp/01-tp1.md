...
<table>
    ...
    <tr>
        <td>Pénalités possibles : <br/>- Plagiat et / ou incapable d'expliquer son code.<br/>- Usage de notions non abordées en classe. (0 pour le TODO)</td>
        <td><br/>-100%<br/>-3.8 à -38 pts</td>
    </tr>
    <tr>
        <td>Total</td>
        <td>38 pts</td>
